...
final class Seed
{
    public static function run(): void
    {
        ...
        $settings = [
            ...
            'business_city' => ['Long Island, NY', 'string'],
            'report_timezone' => ['America/New_York', 'string'],
            ...
            'customer_capture_enabled' => ['1', 'bool'],
            'marketing_opt_in_enabled' => ['1', 'bool'],
            'email_enabled' => ['0', 'bool'],
            'email_order_confirmation_enabled' => ['1', 'bool'],
            ...
            'marketing_from_address' => ['updates@thc-li.com', 'string'],
            'marketing_reply_to' => ['receipts@thc-li.com', 'string'],
