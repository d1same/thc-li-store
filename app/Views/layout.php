  ...
  <?php else: ?>
    <header class="admin-header">
      ...
      <nav class="admin-nav" data-admin-nav>
        ...
        <?php if (can('customers.import')): ?><a href="<?= url('admin/customers/import') ?>" title="Import customers"><i data-lucide="file-up"></i><span>Import customers</span></a><?php endif; ?>
        <?php if (can('campaigns.manage')): ?><a href="<?= url('admin/email') ?>" title="Email center"><i data-lucide="mail-check"></i><span>Email center</span></a><?php endif; ?>
